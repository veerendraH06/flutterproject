import 'package:bmi_calculator_app/utills.dart';
                ...
                RaisedButton(onPressed: (){
                  ...
                  return showDialog(
                    ...
                    builder: (ctx) => AlertDialog(
                      ...
                      title: Text("Alert ",style: TextStyle(color: Colors.white,fontSize: 30,fontStyle: FontStyle.italic ),),
                      content: Text('Your BMI $result \n\n\nYou are $msg',style: TextStyle(color: Colors.white,fontSize: 25),),
                      ...
                      actions: <Widget>[
                        FlatButton(
                          ...
                          child: Text("okay",style: TextStyle(fontSize: 20,color: Colors.black),),
                        ),
                      ],
                    ),
                  );
